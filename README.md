...
launch from the command line:
    ...
    $ lein run -m coffeecounterbot.web
...
get the app created:
    ...
    $ heroku apps:create coffeecounterbot
    Creating coffeecounterbot... done, stack is cedar
    http://coffeecounterbot.herokuapp.com/ | git@heroku.com:coffeecounterbot.git
...
You can deploy the skeleton project immediately:
    ...
    [...]
    -----> Launching... done, v3
           http://coffeecounterbot.herokuapp.com deployed to Heroku

    To git@heroku.com:coffeecounterbot.git
     * [new branch]      master -> master

It's live! Hit it with `curl`:

    $ curl http://coffeecounterbot.herokuapp.com
    ["Hello" :from Heroku]
...
Then you can launch the REPL:
    ...
    $ lein repl :connect http://$REPL_USER:$REPL_PASSWORD@coffeecounterbot.herokuapp.com/repl
